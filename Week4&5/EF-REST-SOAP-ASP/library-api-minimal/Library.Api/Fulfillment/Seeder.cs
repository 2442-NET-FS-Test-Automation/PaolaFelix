...
public class Seeder : ISeeder
{
    ...
    public IReadOnlyList<int> SeedOrders(int n, bool expedited)
    {
        ...
        // Based on n (number of orders the user wants to seed)
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            ids.Add(order.Id); // add the created orders ID to the id list
        }
    ...
    public IReadOnlyList<int> ResetAndCreateOrders (int n)
    {
        ...
        // Similar logic to the burst - just creating mixed orders
        ...
        for (var i = 0; i < n; i ++)
        {
            var order = new Order
            {
                ...
                // You can seed this however you like - for demo were doing modulo checks
