...
var conn_string = builder.Configuration.GetConnectionString("Library") ?? 
    "Server=localhost,1433;Database=LibraryMinimalDb;User Id=sa;Password=Password1234;TrustServerCertificate=true";
...
// might be able to do it in LIbraryDbContect - would have to check how to do that
using (var scope = app.Services.CreateScope())
{
    var db = scope.ServiceProvider.GetRequiredService<LibraryDbContext>();

    // We want this to be idemponent. This block of code runs everytime the app starts
    ...
    if(!db.Users.Any(u => u.Role == "admin"))
    {
        ...
        // I should put that password inside some secret (non GH committed file)
        admin.PasswordHash = hasher.HashPassword(admin, "pass123!"); // put this is a config file please
