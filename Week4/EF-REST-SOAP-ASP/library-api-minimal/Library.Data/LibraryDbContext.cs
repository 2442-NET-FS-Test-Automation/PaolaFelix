...
// All of the code that does the actual SQL generation, creating a connection to myy database,
// doing CRUD, updating the DB based on changes to my models - ALL OF THAT lives in class
// called DbContext. I dont want to modify that class. It comes in from EF Core itself. What I do
...
public class LibraryDbContext : DbContext
{
    ...
    // We ourselves will never call this constructor. ASP.NETs DI container will do it for you
    ...
    {
        // I can set anything I want as far as constraints, mapping column nmes and types
        ...
        // For example here is the same config we did by convention and anotation prior
        b.Entity<Product>(e =>
        {
            // Lets set an index while were her, the one thing to make this worth it
            e.HasIndex(p => p.Sku).IsUnique(); // non key index based on skus being unique
        ...
        // After youve configured your entities (if you do any config in the override)
