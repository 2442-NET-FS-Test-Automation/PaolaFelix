...
// Ive turned my catalog class into a partial class
// I can now strech its class definition across multiple files - when I build, all the content from all the files is stiched together
public partial class Catalog
{
    ...
    // This syntax with the => is the "expression body syntax", if a methos only runs a single expression(one line)
    // than we can use this as a shorthand
