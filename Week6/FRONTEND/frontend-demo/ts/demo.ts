...
import { InventoryItem, HttpStatus, SortDirection, SupplierPrice, 
    FetchState, Sku } from "./types.js";

import { ApiClient } from "./ts-clients.js";

// For now, lets create what our API will hand back to us
const catalog: InventoryItem[] = [
    {sku: "BK-101", name: "Clean Code", currentStock: 5},
    {sku: "BK-102", name: "Dune", currentStock: 3},
    {sku: "BK-103", name: "Refactoring", currentStock: 8}
];
