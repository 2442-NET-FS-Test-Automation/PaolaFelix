...
let name = "jon"; // I actually don't strictly need the type annotation
...
// We do have an escape from rhe strict type system - like var in C#
...
// Tye checking that "unknown" variable's type before use
// makes you prove a shape before you can use it
...
// Labled tuple, fixed lenght, fixed element types
